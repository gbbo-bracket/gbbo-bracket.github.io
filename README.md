...
- **Standings**: A leaderboard page, linked from the nav, with toggles for each 2026 week that's
  already aired (plus whichever week is up next, leaving out Week 1, which had no votes), the 2026
  Finals picks, and the final standings from the 2024 and 2025 seasons. The week and Finals views
  show each person's Star Baker, Technical Winner and Eliminated picks, stacking into their own row
  on mobile so the table stays readable on a phone. Tapping a pick opens that baker's profile
  pop-up, same as the Contestants page but without the arrows to browse to other bakers. Season
  totals (on the home page, 2025 and 2024) show the top three with 🥇🥈🥉 medals and
  gold/silver/bronze ranks; the week and Finals views use plain numbered ranks. The home page points at it from under its own standings table
